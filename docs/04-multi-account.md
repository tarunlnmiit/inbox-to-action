...
Triage several inboxes in **one merged report**, each email tagged with its account. Works for multiple personal Gmail accounts and Google Workspace.
...
| `kind` | `gmail` (Google Workspace uses `gmail` too) |
